    ...
    div(class="sm:flex-col sm:w-full").flex.flex-col.mb-0.max-w-xl.mx-auto
        div(class="md:flex-row lg:flex-row").w-full.h-auto.flex.py-6.px-3.flex-col
            div(class="md:w-1/4 sm:w-full sm:justify-center").flex.justify-start
                ...
                span Pelanggan
                span.font-semibold &nbsp;>
            div(class="md:w-3/4 sm:w-full sm:justify-center").flex.justify-start
                div(class="flex-col sm:w-full md:flex-row").flex
                    div(class=" md:w-1/4 md:text-xs md:px-3").flex.flex-row.w-full.text-2xl.py-2
                        div.flex.w-6.h-6.pr-3
                            span L
                        div.flex.flex-col
        ...
        //-     div
        //-         span.text-xs Email :&nbsp;
        //-         span.text-xs example@sample.com
        //-     div
        //-         span.text-xs Fax :&nbsp;
        //-         span.text-xs (111) 222 333 444
        //- div.px-4.py-2.m-2.bg-blue.rounded.no-underline.text-white.w-auto.flex.flex-row.justify-center
        //-     span.font-bold.m-auto Search
        //-     img(src="https://cdn1.iconfinder.com/data/icons/hawcons/32/698956-icon-111-search-512.png" width="25").m-auto
        //-     span &nbsp;
        //-     input(placeholder="Search").rounded.text-xs.px-2.m-auto.h-8
</template>
