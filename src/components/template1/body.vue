<template lang="pug">
    div(class="lg:flex-row md:flex-col sm:flex-col lg:w-1/2").flex-col.h-auto.flex.mx-auto
            ...
            div(class="lg:w-1/4 lg:text-blue md:w-3/4 md:text-blue sm:w-full sm:text-red").mx-auto.text-teal.flex-wrap.flex-col.py-2.px-2.flex
                div.h-64.overflow-y-auto.rounded.mb-2
                    div.px-2.py-2.mb-2.rounded.bg-green-lighter
                        div
                        h1.font-semibold Content
                        div.border-b-2.w-full.flex.flex-row.mb-2.pb-1
